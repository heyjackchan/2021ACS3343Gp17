...
class testCard {
	...
	//Test case UNIT0106: 
	//Use the card Club-10 to create Card object, set its discard status as true, to test setDiscarded(boolean discarded) function.
	@Test
	...
	//Test case UNIT0107: 
	//Use the card Spade-2 to create Card object, set its discard status as true, to test toString() function.
	@Test
	...
	@Test
	public void testCard_CardD3_getValueSymbol() {
		Card cardD3 = new Card(0,0); //This is the card Diamond-3.
